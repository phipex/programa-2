...
class Regression {
    ...
    static sum(list) {
        ...
        //console.log(list);
        for (i = 0; i < len; i++) {
            payload = list.get(i).getPayload();
            // console.log(payload);
            itemOne = parseFloat(payload.itemOne);
            itemTwo = parseFloat(payload.itemTwo);
            //console.log((itemOne != NaN),itemOne);
            if(itemOne != NaN && itemTwo != NaN){
